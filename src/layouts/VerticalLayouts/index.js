                ...
                return (
                    <React.Fragment key={key}>
                        ...
                        {item['isHeader'] ?
                            ...
                            : (
                                (item.subItems ? item.isAuthorized && (
                                        ...
                                        <Collapse
                                            ...
                                            <ul className="nav nav-sm flex-column test">
                                                ...
                                                {item.subItems && ((item.subItems || []).map((subItem, key) => (
                                                    <React.Fragment key={key}>
                                                        {!subItem.isChildItem ? subItem.isAuthorized && (
                                                            <li className="nav-item">
                                                                <Link
                                                                            ...
                                                                            (subItem.childItems || []).map((childItem, key) => (
                                                                                <React.Fragment key={key}>
                                                                                    {!childItem.childItems ?
                                                                                        childItem.isAuthorized && (<li className="nav-item">
                                                                                            <Link
                                                                                        ...
                                                                                        : childItem.isAuthorized && (<li className="nav-item">
                                                                                            ...
                                                                                            <Collapse className="menu-dropdown" isOpen={childItem.stateVariables} id="sidebaremailTemplates">
                                                                                                <ul className="nav nav-sm flex-column">
                                                                                                    {childItem.childItems.map((subChildItem, key) => subChildItem.isAuthorized && (
                                    ...
                                    item.isAuthorized && (<li className="nav-item">
                                        <Link
                                            className="nav-link menu-link"
                                            to={item.link ? item.link : "/#"}>
