...
//                               <p>
//                                 Hi I'm Anna Adame, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical
//                                 Cambridge friend of mine told me what Occidental is European languages are members of the same family.
//                               </p>
//                               <p>
//                                 You always want to make sure that your fonts work well together and try to limit the number of fonts you use to three or less. Experiment and play around with the fonts
//                                 that you already have in the software you’re working with reputable font websites. This may be the most commonly encountered tip I received from the designers I spoke
//                                 with. They highly encourage that you use different fonts in one design, but do not over-exaggerate and go overboard.
//                               </p>
//                               <Row>
//                                 <Col xs={6} md={4}>
...
//                                                 In an awareness campaign, it is vital for people to begin put 2 and 2 together and begin to recognize your cause. Too much or too little spacing, as in
//                                                 the example below, can make things unpleasant for the reader. The goal is to make your text as comfortable to read as possible. A wonderful serenity has
//                                                 taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.
//                                               </div>
//                                             </UncontrolledCollapse>
//                                           </div>
//                                           <div className="accordion-item border-0">
...
//                                               <div className="accordion-body ms-2 ps-5">
//                                                 " A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. Each design is a
//                                                 new, unique piece of art birthed into this world, and while you have the opportunity to be creative and make your own style choices. "
//                                               </div>
//                                             </UncontrolledCollapse>
//                                           </div>
//                                           <div className="accordion-item border-0">
...
//                                               <div className="accordion-body ms-2 ps-5">
//                                                 It makes a statement, it’s impressive graphic design. Increase or decrease the letter spacing depending on the situation and try, try again until it
...
//                                               <Link className="accordion-button p-2 shadow-none" data-bs-toggle="collapse" to="#collapse7" aria-expanded="false">
//                                                 <div className="d-flex">
//                                                   <div className="avatar-xs">
...
//                                                       Your order is placed <span className="badge bg-soft-success text-success align-middle">Completed</span>
//                                                     </h6>
...
//                                               <Link to="#" className="accordion-button p-2 shadow-none" id="collapse8">
//                                                 <div className="d-flex">
//                                                   <div className="flex-shrink-0 avatar-xs">
...
//                                                   </div>
//                                                   <div className="flex-grow-1 ms-3">
//                                                     <h6 className="fs-14 mb-1">Velzon admin dashboard templates layout upload</h6>
...
//                                               <Link className="accordion-button p-2 shadow-none" data-bs-toggle="collapse" to="#collapse9" aria-expanded="false">
//                                                 <div className="d-flex">
//                                                   <div className="flex-shrink-0">
...
//                                                   <div className="flex-grow-1 ms-3">
//                                                     <h6 className="fs-14 mb-1">
//                                                       New ticket created <span className="badge bg-soft-info text-info align-middle">Inprogress</span>
//                                                     </h6>
//                                                     <small className="text-muted mb-2">
//                                                       User
...
//                                                   " This is an awesome admin dashboard template. It is extremely well structured and uses state of the art components (e.g. one of the only templates
//                                                   using boostrap 5.1.3 so far). I integrated it into a Rails 6 project. Needs manual integration work of course but the template structure made it easy.
//                                                   "
//                                                 </p>
//                                               </div>
//                                             </UncontrolledCollapse>
...
//                                               <Link to="#" className="accordion-button p-2 shadow-none" id="collapse12" aria-expanded="true">
//                                                 <div className="d-flex">
//                                                   <div className="flex-shrink-0">
//                                                     <img src={avatar2} alt="" className="avatar-xs rounded-circle" />
//                                                   </div>
...
//                                               <Link className="accordion-button p-2 shadow-none" data-bs-toggle="collapse" to="#collapse13" aria-expanded="false">
//                                                 <div className="d-flex">
//                                                   <div className="flex-shrink-0">
//                                                     <img src={avatar6} alt="" className="avatar-xs rounded-circle" />
//                                                   </div>
...
//                                 </div>
//                               </div>
//                               <Swiper className="project-swiper" slidesPerView={3} spaceBetween={20} autoplay={{ delay: 3000, disableOnInteraction: false }} pagination={{ clickable: true }}>
...
//                                               Last Update : <span className="fw-semibold text-dark">4 hr Ago</span>
//                                             </p>
//                                           </div>
//                                           <div className="flex-shrink-0 ms-2">
...
//                                                 <div className="avatar-group-item">
//                                                   <div className="avatar-xs">
//                                                     <img src={avatar5} alt="" className="rounded-circle img-fluid" />
//                                                   </div>
//                                                 </div>
//                                                 <div className="avatar-group-item">
//                                                   <div className="avatar-xs">
...
//                                             </h5>
//                                             <p className="text-muted text-truncate mb-0">
//                                               Last Update : <span className="fw-semibold text-dark">1 hr Ago</span>
//                                             </p>
//                                           </div>
//                                           <div className="flex-shrink-0 ms-2">
...
//                                             </h5>
//                                             <p className="text-muted text-truncate mb-0">
//                                               Last Update : <span className="fw-semibold text-dark">2 hr Ago</span>
//                                             </p>
//                                           </div>
//                                           <div className="flex-shrink-0 ms-2">
//                                             <div className="badge badge-soft-warning fs-10">Inprogress</div>
...
//                       {/* <Row>
//                               Contenu de contact details ici
...
//                                   </Item>
//                                   <Item location="after">
//                                     <DropDownButton text="Actions" stylingMode="text" width={120} items={["Assign to Me", "Archive"]} />
//                                   </Item>
//                                   <Item location="after" locateInMenu="auto">
//                                     <div className="separator" />
//                                   </Item>
//                                   <Item location="after" locateInMenu="auto" widget="dxButton" showText="inMenu">
//                                     <Button text="Copy" icon="copy" stylingMode="text" />
//                                   </Item>
//                                   <Item location="after" locateInMenu="auto" widget="dxButton" showText="inMenu">
//                                     <Button text="Refresh" icon="refresh" stylingMode="text" onClick={refresh} />
//                                   </Item>
//                                 </Toolbar>
