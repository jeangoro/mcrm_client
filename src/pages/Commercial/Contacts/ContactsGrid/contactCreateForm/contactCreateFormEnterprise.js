...
const ContactCreateFormEnterprise = ({ onCreateClick, onClearClick }) => {
  ...
  //   { value: "studies/worker", label: "Etudes/Travailleur" },
  // ];
  ...
  const formFieldsEnterprise = [
    {
      ...
      formGroupFields: [
        ...
        //   label: "Vos pays de destination",
        //   type: "select",
        //   isMulti: true,
        //   disabled: false,
        //   value: [],
        //   optionsValue: paysOptions,
        //   validation: Yup.array().notRequired(),
        // },
        // { name: "immigrationTypes", label: "Type d'immigration", type: "select", disabled: false, value: "", optionsValue: immigrationType, validation: Yup.string().notRequired() },
      ],
    },

    {
      formGroupName: "Informations sur l'agence",
      formGroupFields: [
        { name: "enterpriseName", label: "Nom de l'agence", type: "text", disabled: false, value: "", validation: Yup.string().notRequired() },
        { name: "commercialRegisterNumber", label: "Numéro de registre commerce", type: "text", disabled: false, value: "", validation: Yup.string().notRequired() },
        { name: "enterpriseNui", label: "Numéro d'identification (NIU)", type: "text", disabled: false, value: "", validation: Yup.string().notRequired() },
        { name: "enterpriseAddress", label: "Domiciliation de l'agence", type: "text", disabled: false, value: "", validation: Yup.string().notRequired() },
        { name: "enterpriseTel", label: "Téléphone entreprise", type: "phone", disabled: false, value: "", validation: Yup.string().min(9, "trop court").notRequired() },
        { name: "enterpriseEmail", label: "Adresse email entreprise", type: "text", disabled: false, value: "", validation: Yup.string().notRequired() },
        {
          name: "enterpriseCountryResidence",
          label: "Pays",
          type: "select",
          isMulti: false,
          disabled: false,
...
export default ContactCreateFormEnterprise;
