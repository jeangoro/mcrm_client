...
import logo_assurance from "../../../../assets/images/clients/logo_billetavion.png";
...
const BilletAvion = () => {
  ...
  return (
    <div className="accompagnement">
      <Card>
        <CardHeader>
          <h4>Bienvenue dans votre service d’achat de billet d’avion</h4>
        </CardHeader>
        <CardBody>
          <Row>
            <Col xl={6}>
              ...
              <ul>
                ...
                <li>Accompagnement a chaque étape de votre demande d’achat de billet d’avion à savoir : </li>
                <ul>
                  ...
                  - Paiement des frais de reservations vous seront demandé<br></br>
                </ul>
          ...
          <Row>
            ...
            <button
                          ...
                          onClick={()=>navigate("/formbilletavion")}
                        >
