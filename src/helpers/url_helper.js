//REGISTER
export const POST_FAKE_REGISTER = "/account/signUp";

//LOGIN
export const POST_FAKE_LOGIN = "/account/signIn";
...
export const GET_USER_INFO = "/account/getUserInfo";
...
// CRM
// Conatct
export const GET_CONTACTS = "/api/contact/search";
export const SAVE_CONTACT = "/api/contact";
